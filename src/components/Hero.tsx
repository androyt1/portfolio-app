    ...
    return (
        <section id='hero' className=' text-white min-h-screen flex items-center pb-4 font-lato '>
            <div
                ...
                <h1 className='text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-widest font-dmserif'>
                    Building Digital <br /> <span className='text-sky-400'>Experiences</span>
                </h1>
                <h2 className='mt-4 sm:mt-6  text-2xl md:text-4xl text-[#fcfcfb] font-lato'>
                    Crafting Seamless and Intuitive
                    <br /> Web Solutions
                </h2>
                <p className='mt-2 sm:mt-6  text-lg max-w-2xl  text-[#d3d3d3] font-robotoflex'>
